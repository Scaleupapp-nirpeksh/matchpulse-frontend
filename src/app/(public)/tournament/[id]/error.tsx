  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-xl font-semibold text-gray-900 mb-2">Unable to load tournament</h1>
        <p className="text-sm text-gray-500 mb-8">
          This tournament could not be loaded. It may have been removed or there was a connection issue.
        </p>
